...
public class GS1_7X extends GS1 {
    ...
    public GS1_7X() {
        ...
        super.matchers.put("7004", Pattern.compile("^7004[0-9](.){1,4}"));
        ...
        super.matchers.put("7006",Pattern.compile("^7006[0-9](.){1,6}"));       
        super.matchers.put("7006eol",Pattern.compile("^7006[0-9](.){1,6}$"));        
        super.matchers.put("7007",Pattern.compile("^7007[0-9](.){6,12}"));        
        super.matchers.put("7007eol",Pattern.compile("^7007[0-9]{4}(.){6,12}$"));        
        super.matchers.put("7008",Pattern.compile("^7008(.){1,3}[%\\x1D]"));        
        super.matchers.put("7008eol",Pattern.compile("^7008(.){1,3}$"));        
        super.matchers.put("7009",Pattern.compile("^7009[0-9](.){1,10}[%\\x1D]"));        
        super.matchers.put("7009eol",Pattern.compile("^7009[0-9](.){1,10}$")); //poop       
        ...
        super.matchers.put("703s" ,Pattern.compile("^703[0-9]{1}[0-9]{3}(.){1,27}[%\\x1D]"));
        super.matchers.put("703seol" ,Pattern.compile("^703[0-9]{1}[0-9]{3}(.){1,27}$"));
        ...
        super.matchers.put("723s" ,Pattern.compile("^723[0-9]{1}(.){2}(.){1,28}[%\\x1D]"));
        super.matchers.put("723seol" ,Pattern.compile("^723[0-9]{1}(.){2}(.){1,28}$"));
