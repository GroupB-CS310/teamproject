...
public class GS1_8X extends GS1  {
    ...
    public GS1_8X() {
        ...
        super.matchers.put("8003", Pattern.compile("^8003[0-9]{14}(.){1,16}[%\\x1D]")); 
        super.matchers.put("8003eol", Pattern.compile("^8003[0-9]{14}(.){1,16}$")); 
        ...
        super.matchers.put("8011", Pattern.compile("^8011[0-9]{1,12}"));  
        ...
        super.matchers.put("8019", Pattern.compile("^8019(.){1,10}[%//x1D]"));
        super.matchers.put("8019eol", Pattern.compile("^8019(.){1,10}$"));
